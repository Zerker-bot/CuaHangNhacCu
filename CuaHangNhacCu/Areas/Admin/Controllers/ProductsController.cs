...
namespace CuaHangNhacCu.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Cost,IsPublished,Quantity,CreatedAt,UpdatedAt,CategoryId,BrandId,SupplierId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
